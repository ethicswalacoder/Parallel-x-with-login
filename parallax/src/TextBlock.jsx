    ...
    return (
        <div id="textblock">
            <div id="textblock-container">
                <h1 id="textblock-title">Whao is Ethics Wala Coder?</h1>
                <p id="textblock-content">
                The year is 2015.<br/><br/>
            ...
            <footer id='textblock-footer'>Demo Created With 🧡 By&nbsp;<a id="textblock-devsense" href="https://ethicswalacoder.com">Artbangla Bazaar</a></footer>
        </div>
    );
}
